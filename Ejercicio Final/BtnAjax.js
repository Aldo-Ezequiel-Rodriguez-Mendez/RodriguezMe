    $(document).ready(function() {
      ...
      $('#btnConsultaBD').click(function() {
            ...
            swal("Ingresa el ID a consultar:", {
                ...
                .then((parid) => {
                  try {    
                        if (parid=="") {
                              swal("Error", "Favor de no dejar el campo ID vacío", "error");
                        } else {
                              //Primero se busca si el registro existe en la base de datos
                        $.post('php/getRegistro.php',{par1:parid},function(data){
                ...
                .then((idPrenda) => {
                  try {
                        if (idPrenda=="") {
                              ...
                              $.post('php/getRegistro.php',{par1:idPrenda},function(data){
                                    if(data.idCamiseta == null){                                                              //Sino existe mostramos un error
                                          ...
                                          $.post('php/delRegistro.php',{par1:idPrenda},function(data){
        ...
        $('#btnAgregarBD').click(function() {
            try {
                  ...
                  if(nomProveedor == "" || marca == "" || talla == "" || material == "" || stock == "" || Descripcion == "" || Precio == "")
                  {
                        ...
                        $.post('php/addRegistro.php',{par1:idPrenda,par2:nomProveedor,par3:marca,par4:talla,par5:material,par6:stock,par7:Descripcion,par8:Precio},
                        function(data){  
                        },'json');
      ...
      $('#btnModificaBD').click(function() {
            try {
                  ...
                  if(idPrenda == "" || nomProveedor == "" || marca == "" || talla == "" || material == "" || stock == "" || Descripcion == "" || Precio == "")
                  {
                        swal("Error", "Favor de no dejar los campos vacíos", "error");
                  }
                  else{
                        $.post('php/getRegistro.php',{par1:idPrenda},function(data){                                                                         //Buscamos si primero existe el elemento para modificarlo
                              if (data.idCamiseta == null) {                                                                                                  //Si el objeto esta vacio, no existe y mandamos un error
                                    ...
                                    $.post('php/modRegistro.php',{par1:idPrenda,par2:nomProveedor,par3:marca,par4:talla,par5:material,par6:stock,par7:Descripcion,par8:Precio},
                                    function(data){  
                                    },'json');
